...
export class HomeHeader extends Component {
	...
	constructor(props) {
		super (props);
		console.log('constructor HomeHeader')
	}

		render() {
			console.log('HomeHeader props:',this.props);
			...
			return (
				<div className="slds-page-header">
					...
					<p className="slds-text-body--small slds-m-top--x-small"> {this.props.itemCount} {this.props.type.toLowerCase()} • Sorted by Name</p>
				</div>
			);
	}
...
HomeHeader.propTypes = {
	newLabel: React.PropTypes.string,
	icon: React.PropTypes.string
};
